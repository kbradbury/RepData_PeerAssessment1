...
```{r, echo=FALSE}
p1=ggplot(steps.byday,aes(x=steps)) + geom_histogram(binwidth=1000,colour="black",fill="white")
plot(p1)
```
...
p2=ggplot(data=average.steps, aes(x=interval, y=steps, group=1)) + geom_line(colour="red",size=1)
plot(p2)
...
p3=ggplot(steps.byday2,aes(x=steps)) + geom_histogram(binwidth=1000,colour="black",fill="white")
plot(p3)
